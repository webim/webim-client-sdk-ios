...
- (NSURL *)attachmentURLForMessage:(WMMessage *)message {
    ...
    NSString *path = [message.filePath stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLPathAllowedCharacterSet]];
...
- (void)downloadImagePreviewForMessage:(WMMessage *)message key:(NSString *)key completion:(void (^)(BOOL, UIImage *, NSError *))block {
