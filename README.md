...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.35.4'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.35.4
```
...
## Release notes
* File size too small error handling added.
