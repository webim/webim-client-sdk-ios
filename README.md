...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.35.5'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.35.5
```
...
## Release notes
* Too small file size error handling added.
