...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :tag => '3.37.4'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.37.4
```
...
* **IPHONEOS_DEPLOYMENT_TARGET** version increase to 9.0.
