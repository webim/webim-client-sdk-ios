...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.33.0'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.33.0
```
...
## Release notes
* New demo application design.
* Method `isEdited()` added.
* `getNextMessages` bug fixed.
* Sticker support added.
* Method `changed(operator:to:)` bug fixed.
