...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.34.5'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.34.5
```
...
* `FileUrlCreator` bug fixed.
* Reply file message from history bug fixed.
