...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.23.5'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.23.5
```
...
## Release notes
* `getLastMessages` and `getNextMessages` with emprty history bug fixed.
