...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.23.1'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.23.1
```
...
## Release notes
* Unknown type message in current chat bug fixed.
