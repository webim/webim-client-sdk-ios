...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :tag => '3.36.3'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.36.3
```
...
## Release notes
* Authentication UI skip for Keychain added.
