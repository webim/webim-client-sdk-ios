...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.31.4'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.31.4
```
...
## Release notes
*  `getCurrentOperator()` bug is fixed.
* New method for session resuming added.
