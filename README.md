...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.20.1'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.20.1
```
...
## Release notes
* `getLastMessages` and `getNextMessages` bug fixed.
